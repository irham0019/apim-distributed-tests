...
public class APIMANAGER4081PaginationCountTestCase extends APIMIntegrationBaseTest {
    ...
    private final Log log = LogFactory.getLog(APIMANAGER4081PaginationCountTestCase.class);
     ...
     */
    private int getPaginationElementsCount(String storeUrl, String loginResponseCookie, int start,
                                           int offset)
